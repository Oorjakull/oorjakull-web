            ...
            <div className="container mx-auto px-4 md:px-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    {PILLARS.map((pillar) => (
                        <div
                            key={pillar.title}
                            className="group relative p-7 rounded-2xl border border-muted bg-background hover:border-secondary/30 hover:shadow-lg hover:shadow-secondary/8 transition-all duration-300 cursor-default"
                        >
